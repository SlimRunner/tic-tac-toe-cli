...
t3g::T3_Match::T3_Match() noexcept
    : t3g::T3_Board(), m_turn_switch(t3g::T3_cell_state::X_STATE) {
  // nothing else to do
}

t3g::T3_Match::T3_Match(t3g::T3_cell_state starting_symbol) : t3g::T3_Board() {
...
t3g::T3_board_state t3g::T3_Match::make_move(t3g::cell_loc x_loc,
                                             t3g::cell_loc y_loc) {
  ...
  case t3g::T3_board_state::NORMAL_BOARD:
    if (curr_cell == t3g::T3_cell_state::NULL_STATE) {
      ...
      m_turn_switch = (m_turn_switch == ret_t3::X_STATE ? ret_t3::O_STATE
                                                        : ret_t3::X_STATE);
      return retVal;
    } else {
...
void t3g::T3_Match::clear_board(T3_cell_state default_symbol) noexcept {
  ...
  if (m_turn_switch != T3_cell_state::X_STATE &&
      m_turn_switch != T3_cell_state::O_STATE) {
